import { camelize, inject as inject$1, toRef, provide, ref, computed, unref, toRaw, warn, capitalize, watch, onScopeDispose, isVNode, Comment, Fragment, reactive, watchEffect, getCurrentInstance as getCurrentInstance$1, defineComponent as defineComponent$1, toValue, shallowRef, effectScope, hasInjectionContext, createVNode, mergeProps, createElementVNode, isRef, isReactive, getCurrentScope, nextTick, toRefs, markRaw, normalizeClass, createElementBlock, cloneVNode, h, defineAsyncComponent, shallowReactive, Suspense, useSSRContext, createApp, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isShallow } from 'vue';
