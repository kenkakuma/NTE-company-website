import { C as useBorder, v as useElevation, u as useRounded, D as useRouter, E as toPhysical, t as useVariant, g as useDensity, j as useDimension, R as Ripple, F as useLink, k as useLoader, c as useLocation, w as usePosition, o as makeVBtnProps, m as makeRoundedProps, z as makeElevationProps, A as makeBorderProps, y as makeVariantProps, n as makeDensityProps, r as makeDimensionProps, G as makeRouterProps, B as makePositionProps, d as makeLocationProps, q as makeLoaderProps, i as useGroupItem, x as genOverlays, f as VDefaultsProvider, p as makeGroupItemProps, h as useGroup, s as useResizeObserver, H as makeGroupProps, I as parseAnchor, J as flipSide, K as flipAlign, M as flipCorner, N as getAxis, L as LoaderSlot, l as VProgressLinear, V as VBtn } from './VRow-DO-Unv4W.mjs';
import { ref, computed, toRef, watchEffect, shallowRef, capitalize, h, camelize, watch, nextTick, readonly, inject, useId, provide, onScopeDispose, toValue, toRaw, withDirectives, createVNode, mergeProps, createElementVNode, vShow, Fragment, toDisplayString, Transition, TransitionGroup, normalizeStyle, normalizeClass, Teleport, reactive } from 'vue';
import { b as useRender, c as makeComponentProps, u as useBackgroundColor, e as useSize, a as useTextColor, m as makeTagProps, d as makeSizeProps, V as VIcon } from './VIcon-BPJNs7N2.mjs';
import { q as genericComponent, p as propsFactory, C as useProxiedModel, X as useToggleScope, y as useRtl, A as provideTheme, P as useDisplay, B as provideDefaults, o as convertToUnit, al as refElement, H as clamp, g as getCurrentInstance, v as makeThemeProps, a6 as makeDisplayProps, I as IconValue, S as EventProp, ag as focusChild, V as omit, a3 as consoleError, O as useLocale, _ as getPropertyFromItem, af as isPrimitive, E as wrapInArray, aj as isClickInsideElement, ab as useGoTo, K as isObject, aa as onlyDefinedProps, Y as pick, D as deepEqual, ak as getNextElement, ac as focusableChildren, f as destructComputed, ah as CircularBuffer, z as templateRef, U as matchesSelector, ai as defer, ad as defineComponent, ae as deprecate, G as findChildrenWithProvide } from './server.mjs';
...
const VDialog = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    function onAfterEnter() {
      var _a;
      emit("afterEnter");
      if ((props.scrim || props.retainFocus) && ((_a = overlay.value) == null ? void 0 : _a.contentEl) && !overlay.value.contentEl.contains((void 0).activeElement)) {
...
export { animate as A, VExpandXTransition as B, VDialogTransition as C, makeVSlideGroupProps as D, makeLazyProps as E, VSlideYTransition as F, makeItemsProps as G, createSimpleFunctional as H, Intersect as I, standardEasing as J, makeLayoutItemProps as K, useLayoutItem as L, MaybeTransition as M, makeLayoutProps as N, createLayout as O, VListItemTitle as P, VAppBar as V, VToolbarTitle as a, VSpacer as b, VAppBarNavIcon as c, VNavigationDrawer as d, VAvatar as e, VDivider as f, VList as g, VListItem as h, VListSubheader as i, VMain as j, VDialog as k, VCard as l, VCardTitle as m, VCardText as n, VCardActions as o, VSnackbar as p, makeTransitionProps$1 as q, VChip as r, forwardRefs as s, VMenu as t, useItems as u, useScopeId as v, VSlideGroup as w, useSsrBoot as x, useLazy as y, nullifyTransforms as z };
//# sourceMappingURL=VNavigationDrawer-DJMIQFcP.mjs.map
