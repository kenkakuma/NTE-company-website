const n=[{id:1,date:"2025.01.15",title:"無迹探索株式会社設立準備開始のお知らせ",category:"企業ニュース",excerpt:"革新的なソリューションで新たなビジネス価値を創造する企業として、無迹探索株式会社の設立準備を開始いたします。",content:`
    ...
    `,readTime:"3分",tags:["設立","企業情報","イノベーション","事業展開"]},{id:2,date:"2025.01.10",title:"東京ルアー・フライフィッシング学院 2025年春季コース募集開始",category:"サービス",excerpt:"プロフェッショナルな技術指導と最新器具を用いた実践的なフィッシング技術習得プログラムの受講生を募集いたします。",content:`
    ...
    `,readTime:"4分",tags:["フィッシング","スクール","募集","春季コース","技術習得"]},{id:3,date:"2025.01.08",title:"厳選コーヒー商品ラインナップ拡充について",category:"コーヒー事業",excerpt:"世界各地から厳選した高品質コーヒー豆を使用した新商品を順次発表。サステナブルな調達と独自の焙煎技術で最高の品質を実現。",content:`
    ...
    `,readTime:"5分",tags:["新商品","コーヒー","サステナブル","品質","焙煎技術"]},{id:4,date:"2025.01.05",title:"中国アーティスト展示スペース 中目黒オープン準備中",category:"展示・イベント",excerpt:"中目黒に新設する展示スペースでは、中国現代アーティストの作品を中心とした革新的な展示を企画中。2025年春のグランドオープンに向けて準備を進めています。",content:`
    ...
    `,readTime:"6分",tags:["展示空間","中国アート","中目黒","オープン","現代アート","インタラクティブ"]},{id:5,date:"2025.01.03",title:"2025年限定釣具予約受付開始 - Shimano・Daiwa最新モデル",category:"釣具・器具",excerpt:"2025年春発売予定のShimano・Daiwa最新釣具の先行予約を開始。会員限定の特別価格と専門家による選定サービスを提供いたします。",content:`
    ...
    `,readTime:"7分",tags:["釣具","予約受付","Shimano","Daiwa","2025年モデル","会員特典","限定"]}],r=(l=5)=>n.sort((i,t)=>new Date(t.date).getTime()-new Date(i.date).getTime()).slice(0,l);export{n as a,r as g};
