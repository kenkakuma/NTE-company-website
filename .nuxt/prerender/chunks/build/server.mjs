import { camelize, inject as inject$1, toRef, provide, ref, computed, unref, toRaw, warn, capitalize, watch, onScopeDispose, isVNode, Comment, Fragment, reactive, watchEffect, getCurrentInstance as getCurrentInstance$1, defineComponent as defineComponent$1, toValue, shallowRef, effectScope, hasInjectionContext, createVNode, mergeProps, createElementVNode, markRaw, isRef, isReactive, nextTick, getCurrentScope, toRefs, normalizeClass, createElementBlock, cloneVNode, h, defineAsyncComponent, shallowReactive, Suspense, useSSRContext, createApp, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isShallow } from 'file:///Users/eric/WebstormProjects/notrace/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/eric/WebstormProjects/notrace/node_modules/ofetch/dist/node.mjs';
...
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/eric/WebstormProjects/notrace/node_modules/ufo/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/eric/WebstormProjects/notrace/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "lab",
    path: "/lab",
    component: () => import('./lab-BkIQLj5z.mjs')
  },
  {
    name: "club",
    path: "/club",
    component: () => import('./club-kk86PMqC.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-CYhrnazL.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-QO8n3nP1.mjs')
  },
  {
    name: "coffee",
    path: "/coffee",
    component: () => import('./coffee-CSREi7ZJ.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DM7rNHrz.mjs')
  },
  {
    name: "exhibition",
    path: "/exhibition",
    component: () => import('./exhibition-CU1e9b7b.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import('./index-CQ7X56wR.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CUGV0Zcj.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Cazd8g8l.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D5jvVevt.mjs'));
...
export { camelizeProps as $, provideTheme as A, provideDefaults as B, useProxiedModel as C, deepEqual as D, wrapInArray as E, consoleWarn as F, findChildrenWithProvide as G, clamp as H, IconValue as I, hasEvent as J, isObject as K, keyCodes as L, breakpoints as M, isOn as N, useLocale as O, useDisplay as P, createRange as Q, keyValues as R, EventProp as S, filterInputAttrs as T, matchesSelector as U, omit as V, callEvent as W, useToggleScope as X, pick as Y, debounce as Z, getPropertyFromItem as _, useRouter as a, ensureValidVNode as a0, checkPrintable as a1, defineFunctionalComponent as a2, consoleError as a3, getObjectValueByPath as a4, isEmpty as a5, makeDisplayProps as a6, humanReadableFileSize as a7, keys as a8, pickWithRest as a9, onlyDefinedProps as aa, useGoTo as ab, focusableChildren as ac, defineComponent as ad, deprecate as ae, isPrimitive as af, focusChild as ag, CircularBuffer as ah, defer as ai, isClickInsideElement as aj, getNextElement as ak, refElement as al, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry$1 as default, useSeoMeta as e, destructComputed as f, getCurrentInstance as g, isParsableColor as h, isCssColor as i, parseColor as j, getForeground as k, getCurrentInstanceName as l, includes as m, navigateTo as n, convertToUnit as o, propsFactory as p, genericComponent as q, resolveRouteObject as r, useTheme as s, useIcon as t, useHead as u, makeThemeProps as v, flattenFragments as w, defineStore as x, useRtl as y, templateRef as z };
