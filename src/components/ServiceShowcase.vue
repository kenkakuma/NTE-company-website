...
const services = [
  ...
  },
  {
    ...
    category: "アウトドア事業",
    summary: "釣り体験・用具開発",
    description: "釣り関連事業では、釣り体験サービス、釣り具開発、釣りツアー企画を通じて自然との触れ合いを提供しています。初心者から上級者まで、すべてのレベルに対応した総合的な釣りサービスを展開しています。",
    icon: "sailing",
    route: "#fishing",
    features: [
      "釣り体験サービス提供",
  ...
  {
    title: "滑雪 | SKIING",
    category: "ウィンタースポーツ事業",
    summary: "スキー教室・用品・ツアー",
    description: "スキー関連事業では、スキー教室運営、スキー用品販売、スキーツアー企画でウインタースポーツを支援しています。安全で楽しいスキー体験を通じて、ウィンタースポーツの魅力を伝えています。",
  ...
  },
  {
    ...
    description: "研究開発事業では、技術研究、市場分析、イノベーション開発を通じて新たなビジネス価値を創造しています。最先端の研究設備と経験豊富な研究チームにより、お客様のビジネス成長を支援します。",
    icon: "science",
    route: "/lab",
    features: [
      "エクスペリエンスデザイン",
